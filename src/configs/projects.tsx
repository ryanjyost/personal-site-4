export const projects = [
  {
    ...
    desc: (
      <span>
        A video-based career exploration and learning platform, with
        easy-to-implement assignment tools for educators. Led design and
        development as CTO. Learn more at{" "}
        <a href="https://advizehub.com" target="_blank">
          https://advizehub.com
        </a>
      </span>
    ),
  ...
  {
    name: "Screenwriting Interface (Demo)",
    desc: `The basic foundation of screenwriting software interface using Svelte.`,
  ...
  },
  {
    ...
    frontCode: "https://github.com/ryanjyost/depchecker-bot",
    // link: "https://github.com/marketplace/depchecker",
  },
  {
    name: "React Simple Storage",
    desc: "Simple component and helper functions for using web storage with React. ",
    preview: "simple-storage",
  ...
  //   desc: "Tools and checklists to help adults-in-progress stress less about their personal finances.",
  //   preview: "fjf",
  //   skills: [
  //     "Ember",
  //     "Handlebars",
